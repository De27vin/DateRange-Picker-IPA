...
use App\Searchable\Exceptions\InvalidModelSearchAspect;
use App\Searchable\Exceptions\InvalidSearchableModel;
...
class ModelSearchAspect extends SearchAspect
{
     ...
     *
     * @throws \App\Searchable\Exceptions\InvalidSearchableModel
     */
    public function __construct(string $model, bool $explodePhrase, $attributes = [])
    {
        ...
        $this->model = $model;
        $this->explodePhrase = $explodePhrase;
    ...
    protected function addSearchConditions(Builder $query, string $term)
    {
        ...
        $searchTerms = $this->explodePhrase ? explode(' ', $term) : [$term];
