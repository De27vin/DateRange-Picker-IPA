...
namespace App\Searchable\Exceptions;
...
class InvalidSearchableModel extends Exception
{
    ...
    {
        return new self("Model `{$model}` is added as a model search aspect but does not implement the `App\Searchable\Searchable` interface.");
    }
}
