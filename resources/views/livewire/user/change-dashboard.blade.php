...
<div class="pb-12 mx-auto px-4">
    <x-page.header class="mt-8 mb-2 h-20">
        ...
        <x-slot name="description">@lang('Your personal dashboard defaults. Reset returns these values to the account-wide defaults.')</x-slot>
        <x-slot name="actionButtons">
            <div class="flex justify-end mb-2 gap-2">
                <x-button.primary wire:click="updateDashboardSettings">@lang('Update')</x-button.primary>
                <x-button.secondary wire:click="cancelDashboardSettings">@lang('Cancel')</x-button.secondary>
                <x-button.secondary wire:click="resetDashboardSettings">@lang('Reset')</x-button.secondary>
            </div>
        </x-slot>
    </x-page.header>
