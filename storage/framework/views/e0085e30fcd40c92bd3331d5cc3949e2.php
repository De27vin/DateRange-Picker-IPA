  ...
  <template x-for="(message, messageIndex) in messages" :key="messageIndex" hidden>
    <div x-transition:enter="transform ease-out duration-300 transition"
      ...
      <div class="flex-1 p-4">
        ...
        <!-- Message Content -->
        <div>
          <p x-text="message[0] ?? '<?php echo e(__('Error occurred on update')); ?>'" class="text-custom-smaller text-gray-900"></p>
        </div>
      </div>
...
<?php if(session('global-handler-error')): ?>
    setTimeout(() => {
        window.dispatchEvent(
            new CustomEvent('notifyerror', {
                detail: { message: "<?php echo e(__('Error occurred on update')); ?>" }
            })
        );
    }, 500);
<?php endif; ?>
</script><?php /**PATH C:\Users\devin\Documents\SynologyDrive\Privat\Serv24\Laravel-VueJS\Kopie-UCP-web-UI\src\resources\views/components/notification.blade.php ENDPATH**/ ?>