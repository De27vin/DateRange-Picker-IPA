...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page.tabs-secondary','data' => ['target' => $device,'defaultTab' => 'customFields','tabs' => [
...
<?php endif; ?>
<?php $component->withAttributes(['target' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($device),'defaultTab' => 'customFields','tabs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                'customFields' => __('Custom fields'),
                'programmableSettings' => __('Programmable settings'),
                'nonProgrammableSettings' => __('Advanced settings'),
            ]),'verticalSpace' => true,'buttonsOnTop' => true]); ?>

             <?php $__env->slot('customFieldsButtons', null, []); ?> 
                <?php if($canWriteSettings && count($deviceCustomFields)): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button.primary','data' => ['wire:click' => 'updateDeviceCustomFields']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'updateDeviceCustomFields']); ?><?php echo app('translator')->get('Update'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button.secondary','data' => ['type' => 'button','onclick' => 'window.dispatchEvent(new CustomEvent(\'closeModal_deviceSettingsCustomFields\'))']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','onclick' => 'window.dispatchEvent(new CustomEvent(\'closeModal_deviceSettingsCustomFields\'))']); ?><?php echo app('translator')->get('Cancel'); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
             ...
             <?php $__env->slot('programmableSettingsButtons', null, []); ?> 
                <?php if(count($deviceSettingsProgrammable)): ?>
                    <div class="flex w-full justify-end gap-2">
                        <?php if (isset($component)) { $__componentOriginal79c47ff43af68680f280e55afc88fe59 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal79c47ff43af68680f280e55afc88fe59 = $attributes; } ?>
...
<?php endif; ?>
             ...
             <?php $__env->slot('nonProgrammableSettingsButtons', null, []); ?> 
                <?php if(count($deviceSettingsNonProgrammable)): ?>
                    <div class="flex w-full justify-end gap-2">
                        <?php if (isset($component)) { $__componentOriginal79c47ff43af68680f280e55afc88fe59 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal79c47ff43af68680f280e55afc88fe59 = $attributes; } ?>
                    ...
                    <div class="md:flex flex-wrap mb-0">
                        <div class="block w-full">
                            <div class="ml-8 justify-between pb-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $deviceCustomFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customKey => $customField): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php $component->withAttributes(['for' => ''.e($customKey).'','fallback' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('')]); ?>
                                            <?php echo e(!empty($customField['translations'][$locale]) ? $customField['translations'][$locale] : $customField['name']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.defer' => 'deviceCustomFields.'.e($customKey).'.value','canWriteSettings' => ''.e($canWriteSettings).'','type' => 'text','name' => ''.e($customKey).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <p class="col-span-4 text-sm py-2 px-4 mb-8 mx-1 text-white bg-color-new-400"><?php echo app('translator')->get('No custom fields are configured for Devices.'); ?></p>
                                <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.programmable-settings','data' => ['programmableSettings' => $deviceSettingsProgrammable,'updateMethodName' => 'updateProgrammableSetting','model' => 'deviceSettingsProgrammable','target' => $device]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['programmableSettings' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($deviceSettingsProgrammable),'updateMethodName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('updateProgrammableSetting'),'model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('deviceSettingsProgrammable'),'target' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($device)]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.advanced-settings','data' => ['advancedSettings' => $deviceSettingsNonProgrammable,'updateMethodName' => 'updateNonProgrammableSettings','model' => 'deviceSettingsNonProgrammable']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['advancedSettings' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($deviceSettingsNonProgrammable),'updateMethodName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('updateNonProgrammableSettings'),'model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('deviceSettingsNonProgrammable')]); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <script>
        window.deviceSettingsLivewireId = '<?php echo e($this->id); ?>';
    </script>

</div><?php /**PATH C:\Users\devin\Documents\SynologyDrive\Privat\Serv24\Laravel-VueJS\Kopie-UCP-web-UI\src\resources\views/livewire/ucp/device-settings-custom-fields.blade.php ENDPATH**/ ?>