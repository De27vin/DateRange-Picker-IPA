...
<?php $__env->startSection('content'); ?>
  ...
  <script>
  window.EQUIPMENT_STATS = <?php echo json_encode(['enabled' => $enabled, 'disabled' => $disabled]); ?>;
  window.ALARM_STATS = <?php echo json_encode(['inbound' => $inbound, 'active' => $activeAlarms]); ?>;
  // ALERTS_STATS is a mapping of alert_type => device_count used by AlertsChart.vue
  window.ALERTS_STATS = <?php echo json_encode([
  ...
  window.SERVICE_STATS = <?php echo json_encode(['periodicalCalls' => $periodicalCalls ?? 0, 'localChecks' => $localChecks ?? 0]); ?>;
  </script>

    <script src="<?php echo e(mix('/vue/vue-charts.js')); ?>"></script>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\devin\Documents\SynologyDrive\Privat\Serv24\Laravel-VueJS\Kopie-UCP-web-UI\src\resources\views/pages/charts-new.blade.php ENDPATH**/ ?>